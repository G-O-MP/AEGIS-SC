from .modules import *
import torch
from .encoder import SwinTransformerBlock, AdaptiveModulator
import datetime
    ...
    def __init__(self, img_size, embed_dims, depths, num_heads, C,
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(dim=int(embed_dims[i_layer]),
                               out_dim=int(embed_dims[i_layer + 1]) if (i_layer < self.num_layers - 1) else out_chans,
